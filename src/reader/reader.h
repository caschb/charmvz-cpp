 ...
 * @return StsData Structure containing chares, entries, and messages from the file
 */
 ...
 * @return std::vector<Timeline> Vector of Timeline objects parsed from the log files
 */
std::vector<Timeline>
