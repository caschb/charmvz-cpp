...
auto to_string(const LogType &type) -> const char * {
  ...
  case LogType::ENQUEUE:
    return "ENQUEUE";
  case LogType::DEQUEUE:
    return "DEQUEUE";
  case LogType::BEGIN_COMPUTATION:
    return "BEGIN_COMPUTATION";
  case LogType::END_COMPUTATION:
    return "END_COMPUTATION";
  case LogType::BEGIN_INTERRUPT:
    return "BEGIN_INTERRUPT";
  case LogType::END_INTERRUPT:
    return "END_INTERRUPT";
  case LogType::MESSAGE_RECV:
    return "MESSAGE_RECV";
  case LogType::BEGIN_TRACE:
    return "BEGIN_TRACE";
  case LogType::END_TRACE:
    return "END_TRACE";
  ...
  case LogType::MEMORY_MALLOC:
    return "MEMORY_MALLOC";
  case LogType::MEMORY_FREE:
    return "MEMORY_FREE";
